Citizen.CreateThread(function()
  ...
  KOTH.Maps = {
    [1] = {
      ...
      Spawns = {
        ["Yellow"] = {Player = {x = 1370.23, y = 2797.582, z = 49.87}, Shop = {x = 1387.274, y = 2799.048, z = 51.25308, p = 0.0, r = 0.0, yaw = 190.0}, Car = {x = 1433.72, y = 2795.57, z = 52.45, h = 12.74}, Helicopter = {x = 200.0, y = 999.0, z = 555.0, h = 0.0}},
    ...
    [2] = {
      ...
      Spawns = {
        ["Yellow"] = {Player = {x = 1732.87, y = 3684.40, z = 34.7}, Shop = {x = 1741.97, y = 3690.58, z = 33.55, p = 0.0, r = 0.0, yaw = -65.0}, Car = {x = 1719.49, y = 3674.17, z = 34.69, h = 201.66}, Helicopter = {x = 0.0, y = 0.0, z = 0.0, h = 0.0}},
